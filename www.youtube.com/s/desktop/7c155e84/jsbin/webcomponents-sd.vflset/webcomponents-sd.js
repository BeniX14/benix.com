...
*/
  ...
  k.Va = function (a, b) {
    ...
    Q
      ? l.J
        ? ((l.J.textContent = h), (e = l.J))
        : h && (e = Dd(h, g, a.shadowRoot, l.placeholder))
      : e
      ? e.parentNode ||
        (ge && -1 < h.indexOf("@media") && (e.textContent = h),
        Ed(e, null, l.placeholder))
      : h && (e = Dd(h, g, null, l.placeholder));
    e &&
    ...
    Q ||
      ...
      f &&
        (l = h.replace(new RegExp("\\s*x-scope\\s*" + f + "\\s*", "g"), " ")),
      (l += (l ? " " : "") + "x-scope " + e),
      h !== l && Id(a, l));
