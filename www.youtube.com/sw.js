/** 4558032900350701565 */ self.document = self;
self.window = self;
var ytcfg = {
  d: function () {
...
ytcfg.set({
  ...
  INNERTUBE_CLIENT_VERSION: "2.20231003.02.02",
  INNERTUBE_CONTEXT: {
    client: {
      hl: "hu",
      gl: "RO",
  ...
  INNERTUBE_CONTEXT_CLIENT_VERSION: "2.20231003.02.02",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
  const swPolicy = trustedTypes.createPolicy("youtubeServiceWorkerPolicy", {
    createScriptURL: function (ignored) {
      return "https://www.youtube.com/s/desktop/7c155e84/jsbin/serviceworker-kevlar-appshell.vflset/serviceworker-kevlar-appshell.js";
    },
  });
  importScripts(swPolicy.createScriptURL(""));
} else {
  importScripts(
    "https://www.youtube.com/s/desktop/7c155e84/jsbin/serviceworker-kevlar-appshell.vflset/serviceworker-kevlar-appshell.js"
  );
}
